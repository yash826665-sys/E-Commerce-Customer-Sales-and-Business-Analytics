...
- **Tableau:** three dashboards (Executive Overview, Customer Analytics, Product & Operations) — see `tableau/TABLEAU_IMPLEMENTATION_GUIDE.md` for step-by-step rebuild instructions
